...
const defineJQueryPlugin = (plugin) => {
  onDOMContentLoaded(() => {
    ...
    if ($) {
      ...
      const JQUERY_NO_CONFLICT = $.fn[name2];
      $.fn[name2] = plugin.jQueryInterface;
      $.fn[name2].Constructor = plugin;
      $.fn[name2].noConflict = () => {
        $.fn[name2] = JQUERY_NO_CONFLICT;
...
const enableDismissTrigger = (component, method = "hide") => {
  ...
  EventHandler.on(document, clickEvent, `[data-bs-dismiss="${name2}"]`, function(event) {
    ...
    const target = getElementFromSelector(this) || this.closest(`.${name2}`);
...
const footer = {
  template: `<nav class="navbar navbar-expand-sm fixed-bottom text-center justify-content-center bg-dark">
        <div class="text-light">Rubén Henares Hidalgo</div>
    </nav>`
};
...
const enrutador = {
  rutas: {
    home: __vitePreload(() => import("./homeVista-c31dec35.js"), true ? ["./homeVista-c31dec35.js","./pokemons-162460cb.js","./partida-6fac8258.js"] : void 0, import.meta.url),
    // Usuarios
    registro: __vitePreload(() => import("./registroVista-13bd5b7b.js"), true ? [] : void 0, import.meta.url),
    login: __vitePreload(() => import("./loginVista-288409db.js"), true ? [] : void 0, import.meta.url),
    perfiles: __vitePreload(() => import("./perfil-314a9d51.js"), true ? [] : void 0, import.meta.url),
    pokemons: __vitePreload(() => import("./juegoPokemon-0bbacd20.js"), true ? ["./juegoPokemon-0bbacd20.js","./pokemons-162460cb.js"] : void 0, import.meta.url),
    partidas: __vitePreload(() => import("./partida-a6397c07.js"), true ? ["./partida-a6397c07.js","./partida-6fac8258.js"] : void 0, import.meta.url)
  },
  router: async () => {
...
class Perfil {
  ...
  static async getAll() {
    const { data: perfil, error } = await supabase.from("perfiles").select("*");
    if (error) {
      throw new Error(error.message);
    }
